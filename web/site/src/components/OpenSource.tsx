      ...
      <div className="section-container">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <p className="text-text-body mb-10">
            Lattice is open source and always will be. Run it on your own infrastructure,
            your own terms. No vendor lock-in, no surprise pricing changes.
          </p>
          ...
          <div className="mt-12 flex items-center justify-center gap-8 text-text-secondary">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm">Embedded SQLite</span>
            </div>
          </div>
        </div>
      </div>
